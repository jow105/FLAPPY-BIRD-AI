...
class QNet(object):
	...
	def update(self, last_input, last_choice, last_prediction, crash, scored, playerY, pipVelX):
		...
		# elif(new_distY >= -40 and new_distY <= 30):
		...
		# 			reward_f += 10
			...
			if(new_distX <= 50 and new_distX >= 25):
				...
				if(last_choice == 1):
					reward_f += 10
		elif(new_distY > 30 and new_distY < 50):
			if(last_choice == 0):
				reward_nf += -20
			if(last_choice == 1):
				reward_f += 20
		elif(new_distY >= -100 and new_distY < -40):
			if(last_choice == 0):
				reward_nf += -20
			if(last_choice == 1):
				reward_f += 20
		...
		# elif(new_distY <= PIPEGAPSIZE/4 and new_distY > 0):
		# 	if(last_choice == 0):
		# 		reward_nf += -10
		# 	if(last_choice == 1):
		# 		reward_f += 10
		# elif(new_distY > PIPEGAPSIZE/4):
		# 	if(last_choice == 0):
		# 		reward_nf += 10
		# 	if(last_choice == 1):
		# 		reward_f += -30
		# elif(new_distY > -1 * PIPEGAPSIZE/2 and new_distY <= 0):
		# 	if(last_choice == 0):
		# 		reward_nf += -20
		# 	if(last_choice == 1):
		# 		reward_f += 20
		# elif(new_distY > -1 * PIPEGAPSIZE and new_distY <= -1 * PIPEGAPSIZE/2):
		# 	if(last_choice == 0):
		# 		reward_nf += -30
		# 	if(last_choice == 1):
		# 		reward_f += 30
